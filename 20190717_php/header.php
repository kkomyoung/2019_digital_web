...
<head>
   ...
   <style>
      *{padding: 0; margin: 0;}
      ...
      #main_footer{
         width: 1200px;height: 300px; margin: 0 auto; background-color: skyblue;
      }
      ...
      #sub02_content #sub_section{width:100%;height: 2000px;background-color: green;}

      #sub03_content{width: 1200px;margin:0 auto;}
      #sub03_content #sub_section{width:100%;height: 2000px;background-color: violet;}

      #sub04_content{width: 1200px;margin:0 auto;}
      #sub04_content #sub_section{width:100%;height: 2000px;background-color: red;}
